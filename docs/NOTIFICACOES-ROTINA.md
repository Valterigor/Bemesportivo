...
O valor de `WEB_PUSH_SUBJECT` deve ser `mailto:bemesportivo@yahoo.com`. Nunca salve a chave privada no Git. O arquivo `wrangler.notifications.jsonc` configura o Cron `* * * * *` e o binding `BE_DATA`.
