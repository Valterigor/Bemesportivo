...
async function run() {
  ...
  try {
    ...
    assert.match(pathHtml, /css\/meu-caminho-diary\.css\?v=20260731-2/);
    assert.match(pathHtml, /js\/meu-caminho-diary\.js\?v=20260731-2/);
    ...
    assert.match(serviceWorker, /CACHE_NAME = 'meu-caminho-be-v66'/);
    ...
    assert.match(serviceWorker, /\/js\/meu-caminho-diary\.js\?v=20260731-2/);
