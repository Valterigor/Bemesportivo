...
function drawKobemBackRunner(ctx,x,y,bob,runCycle,activePowerups,color,accent,jump,slide,tilt,turnBoost){
  ...
  const shadowScale = 1 - Math.min(.56,jump/330);
  ctx.fillStyle = 'rgba(0,0,0,.42)';
  ctx.beginPath();
  ctx.ellipse(0,56,86 * shadowScale,22 * shadowScale,0,0,Math.PI*2);
  ctx.fill();
  ...
  const body = ctx.createLinearGradient(-70,-96,70,46);
  body.addColorStop(0,'#fffdf8');
  body.addColorStop(.18,'#f4f7fb');
  body.addColorStop(.42,color);
  body.addColorStop(.72,'#e75e05');
  body.addColorStop(1,'#0e1118');
  ctx.fillStyle = body;
  ctx.shadowColor = 'rgba(0,0,0,.36)';
  ctx.shadowBlur = 18;
  roundRect(ctx,-62,-88,124,132,34);
  ctx.fill();
  ctx.shadowBlur = 0;
  ...
  roundRect(ctx,-55,-71,18,86,13);
  ctx.fill();
  ctx.fillStyle = 'rgba(0,0,0,.28)';
  roundRect(ctx,38,-69,18,84,13);
  ctx.fill();
  ctx.fillStyle = 'rgba(0,0,0,.2)';
  roundRect(ctx,-47,18,94,15,8);
  ctx.fill();

  ctx.fillStyle = '#0b1018';
  roundRect(ctx,-42,-58,84,88,22);
  ctx.fill();
  ctx.strokeStyle = 'rgba(66,232,255,.38)';
  ctx.lineWidth = 3;
  ctx.stroke();
  const core = ctx.createLinearGradient(-28,-42,28,16);
  core.addColorStop(0,'rgba(255,255,255,.18)');
  core.addColorStop(.48,'rgba(66,232,255,.12)');
  core.addColorStop(1,'rgba(0,0,0,.24)');
  ctx.fillStyle = core;
  roundRect(ctx,-28,-42,56,58,16);
  ctx.fill();
  ctx.fillStyle = accent;
  ctx.shadowColor = accent;
  ctx.shadowBlur = 12;
  ...
  ctx.fillText('K',0,-14);
  ctx.shadowBlur = 0;
  ctx.strokeStyle = 'rgba(252,110,2,.72)';
  ctx.lineWidth = 3;
  ctx.beginPath();
  ctx.moveTo(0,-54);
  ctx.lineTo(0,24);
  ...
  roundRect(ctx,-23,-34,46,7,4);
  ctx.fill();
  ctx.fillStyle = 'rgba(0,0,0,.32)';
  roundRect(ctx,-27,5,54,8,4);
  ctx.fill();
  ...
  const pod = ctx.createLinearGradient(-96,-138,96,-84);
  pod.addColorStop(0,'#ffffff');
  pod.addColorStop(.44,color);
  pod.addColorStop(1,'#11151d');
  ctx.fillStyle = pod;
  roundRect(ctx,-100,-139,34,62,18);
  ctx.fill();
  roundRect(ctx,66,-139,34,62,18);
  ctx.fill();
  ctx.fillStyle = 'rgba(10,10,10,.5)';
  roundRect(ctx,-91,-126,16,34,8);
  ctx.fill();
  roundRect(ctx,75,-126,16,34,8);
  ctx.fill();

  const head = ctx.createLinearGradient(-88,-184,88,-54);
  head.addColorStop(0,'#fffdf8');
  head.addColorStop(.18,'#ffffff');
  head.addColorStop(.32,color);
  head.addColorStop(.68,'#f47a08');
  head.addColorStop(1,'#171b24');
  ctx.fillStyle = head;
  ...
  ctx.fillStyle = '#0b1018';
  roundRect(ctx,-58,-156,116,78,30);
  ctx.fill();
  ctx.strokeStyle = 'rgba(66,232,255,.42)';
  ctx.lineWidth = 3;
  ctx.stroke();
  ctx.fillStyle = 'rgba(255,255,255,.2)';
  roundRect(ctx,-42,-144,84,17,9);
  ctx.fill();
  ctx.fillStyle = 'rgba(252,110,2,.7)';
  roundRect(ctx,-36,-116,72,8,4);
  ctx.fill();
  ctx.fillStyle = 'rgba(0,0,0,.36)';
  roundRect(ctx,-30,-101,60,15,8);
  ctx.fill();
...
function drawBackLeg(ctx,x,y,phase,color,accent,side=1){
  ...
  const upper = ctx.createLinearGradient(-20,-8,20,48);
  upper.addColorStop(0,'#282e38');
  upper.addColorStop(.5,'#111720');
  upper.addColorStop(1,'#070a0f');
  ctx.fillStyle = upper;
  roundRect(ctx,-18,-8,36,60,15);
  ctx.fill();
  ctx.fillStyle = 'rgba(255,255,255,.16)';
  roundRect(ctx,-8,-2,8,42,5);
  ctx.fill();
  ctx.fillStyle = '#070a0f';
  ctx.beginPath();
  ctx.arc(0,48,16,0,Math.PI*2);
  ctx.fill();
  ctx.strokeStyle = 'rgba(66,232,255,.4)';
  ctx.lineWidth = 3;
  ctx.stroke();

  const bootY = 50 + phase.plant * 4;
  const boot = ctx.createLinearGradient(-27,bootY,27,bootY + 34);
  boot.addColorStop(0,'#ff8d24');
  boot.addColorStop(.48,color);
  boot.addColorStop(1,'#11151d');
  ctx.fillStyle = boot;
  roundRect(ctx,-28,bootY,56,34,14);
  ctx.fill();
  ctx.fillStyle = 'rgba(255,255,255,.24)';
  roundRect(ctx,-20,bootY + 6,24,7,4);
  ctx.fill();
  ctx.strokeStyle = accent;
  ctx.lineWidth = 3;
  ctx.stroke();
  ctx.fillStyle = 'rgba(0,0,0,.34)';
  roundRect(ctx,-30,bootY + 24,60,9,6);
  ctx.fill();
  ctx.restore();
}
...
function drawBackArm(ctx,x,y,phase,color,accent,side=1){
  ...
  const shoulder = ctx.createLinearGradient(-24,-19,24,13);
  shoulder.addColorStop(0,'#fffaf2');
  shoulder.addColorStop(.42,color);
  shoulder.addColorStop(1,'#11151d');
  ctx.fillStyle = shoulder;
  roundRect(ctx,-24,-20,48,33,16);
  ctx.fill();
  ctx.strokeStyle = 'rgba(255,255,255,.32)';
  ctx.lineWidth = 3;
  ctx.stroke();

  const forearm = ctx.createLinearGradient(-16,5,16,58);
  forearm.addColorStop(0,color);
  forearm.addColorStop(.58,'#c94f04');
  forearm.addColorStop(1,'#10141b');
  ctx.fillStyle = forearm;
  roundRect(ctx,-16,5,32,56,15);
  ctx.fill();
  ctx.fillStyle = 'rgba(255,255,255,.2)';
  roundRect(ctx,-9,12,7,34,5);
  ctx.fill();

  ctx.fillStyle = '#f7f7f7';
  roundRect(ctx,-22,50,44,28,14);
  ctx.fill();
  ctx.strokeStyle = accent;
  ctx.lineWidth = 3;
  ctx.stroke();
