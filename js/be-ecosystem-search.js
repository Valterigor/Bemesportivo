(function (global) {
  ...
  const PRODUCTS = Object.freeze([
    ...
    { id: 'radar', name: 'Radar BE', purpose: 'Encontre onde praticar em São Paulo.', response: 'Veja oportunidades esportivas, centros e programações para começar perto de você em São Paulo.', action: 'Abrir o Radar BE', href: '/radar-esportivo', keywords: ['onde praticar', 'onde treinar', 'esporte perto', 'perto de mim', 'sao paulo', 'são paulo', 'quadra', 'centro esportivo', 'ceu', 'atividade gratuita', 'local para esporte'] },
  ...
  const SEARCH_ITEMS = Object.freeze([
    ...
    { product: 'radar', title: 'Radar BE São Paulo', summary: 'Encontre centros esportivos, CEUs e oportunidades para se movimentar na cidade.', href: '/radar-esportivo', image: '/img/radar/centros-esportivos-sp.jpg', action: 'Explorar o Radar', keywords: ['onde praticar', 'onde treinar', 'sao paulo', 'são paulo', 'perto de mim', 'centro esportivo', 'ceu', 'quadra', 'atividade gratuita', 'esporte perto'] },
