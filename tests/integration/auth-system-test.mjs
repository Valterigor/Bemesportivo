...
assert.match(html, /ACESSO LOCAL[\s\S]*Nome de acesso[\s\S]*Concluir perfil e acessar/);
assert.match(html, /Seu nome ou apelido cria o acesso neste aparelho ao final do Perfil Be, sem e-mail ou senha/);
